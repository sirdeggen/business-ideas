...
export const OVERLAY_STORAGE_KEY = 'datasets.overlayUrl'

export const LOCAL_OVERLAY_HINT =
  'Optional overlay URL override. Topic stays tm_anytx / ls_anytx — this stall does not invent a custom topic.'
