...
<p>HTTP already named the other product. Status <code>402 Payment Required</code> means the resource is for sale, not that you failed a login. <a href="https://bsv.brc.dev/payments/0121">BRC-121</a> on BSV makes that status machine-readable: the server states a satoshi amount and an identity key; the client pays and retries with a transaction. No account, no cookie session, no “subscribe to continue.”</p>
