...
/** Board copy: stored dollars, or a converted amount, never a “sats” lead. */
export function displayUsd(amountUsd?: string | number, sats?: number, usdPerBsv?: number | null): string {
