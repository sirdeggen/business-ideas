...
import { LOOKUP_SERVICE, TOPIC } from '../../protocol/raffle'
import RaffleLookupServiceFactory from './raffle/RaffleLookupServiceFactory'
import RaffleTopicManager from './raffle/RaffleTopicManager'
...
const main = async (): Promise<void> => {
  ...
  server.configureTopicManager(TOPIC, new RaffleTopicManager())
  server.configureLookupServiceWithMongo(LOOKUP_SERVICE, RaffleLookupServiceFactory)
