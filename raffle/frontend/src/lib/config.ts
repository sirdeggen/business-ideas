...
export const OVERLAY_STORAGE_KEY = 'raffle.overlayUrl'

export const LOCAL_OVERLAY_HINT =
  'Optional local Docker override: cd raffle && docker compose up --build (overlay :8084, UI :5177), then set Overlay URL to http://localhost:8084 for tm_raffle / ls_raffle.'
